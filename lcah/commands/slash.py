...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available LCAH skills.", ("sk",)),
    SlashCommand("auto-skills", "/auto-skills", "List project auto-skills."),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a LCAH skill."),
    ...
    SlashCommand("exit", "/exit", "Exit LCAH.", ("quit",)),
)
