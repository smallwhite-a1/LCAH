...
BASE_TOOL_SPECS = {
    ...
    **PLAN_TOOL_SPECS,
    **ASK_USER_TOOL_SPECS,
    **auto_skills.AUTOSKILL_TOOL_SPECS,
}
...
TOOL_EXAMPLES = {
    ...
    **PLAN_TOOL_EXAMPLES,
    **ASK_USER_TOOL_EXAMPLES,
    **auto_skills.AUTOSKILL_TOOL_EXAMPLES,
}
...
def validate_tool(agent, name, args):
    ...
    if name in ASK_USER_TOOL_SPECS:
        ...
        return
    if name in auto_skills.AUTOSKILL_TOOL_NAMES:
        auto_skills.validate_auto_skill_tool(agent, name, args)
        return
...
_TOOL_RUNNERS = {
    ...
    "find_skill": auto_skills.tool_find_skill,
    "read_skill": auto_skills.tool_read_skill,
    "skill_create": auto_skills.tool_skill_create,
    "update_skill": auto_skills.tool_update_skill,
    "skill_note": auto_skills.tool_skill_note,
    "skill_eval": auto_skills.tool_skill_eval,
}
