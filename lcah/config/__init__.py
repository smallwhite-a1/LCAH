...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "lcah" / "config.toml"
PROJECT_CONFIG_NAME = ".lcah.toml"
...
ENV_PROVIDER = "LCAH_PROVIDER"
ENV_API_KEY = "LCAH_API_KEY"
ENV_BASE_URL = "LCAH_BASE_URL"
ENV_MODEL = "LCAH_MODEL"
...
LEGACY_ENV_NAMES = {
    "openai": {
        "api_key": ("LCAH_OPENAI_API_KEY", "OPENAI_API_KEY"),
        "base_url": ("LCAH_OPENAI_API_BASE", "OPENAI_API_BASE", "OPENAI_BASE_URL"),
        "model": ("LCAH_OPENAI_MODEL", "OPENAI_MODEL"),
    },
    "anthropic": {
        "api_key": (
        ...
        "base_url": (
            "LCAH_ANTHROPIC_API_BASE",
            "ANTHROPIC_API_BASE",
            "ANTHROPIC_BASE_URL",
        ),
        "model": ("LCAH_ANTHROPIC_MODEL", "ANTHROPIC_MODEL"),
    },
    "deepseek": {
        "api_key": ("LCAH_DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY"),
        "base_url": (
            "LCAH_DEEPSEEK_API_BASE",
            "DEEPSEEK_API_BASE",
            "DEEPSEEK_BASE_URL",
        ),
        "model": ("LCAH_DEEPSEEK_MODEL", "DEEPSEEK_MODEL"),
    },
}
...
def resolve_provider_config(
    ...
    *,
    ...
    protocol = _first_value(
        None,
        os.environ.get("LCAH_PROTOCOL"),
        profile_values.get("protocol"),
        legacy_env.get("LCAH_PROTOCOL"),
...
def _read_config_file(path: Path) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f"invalid LCAH config file {path}: {exc}") from exc
    except OSError as exc:
        raise ValueError(f"could not read LCAH config file {path}: {exc}") from exc
